...
const Logo = () => {
    ...
    const outlineLogoControls = useAnimation();
    const solidLogoControls = useAnimation();
    ...
    useEffect(() => {
        ...
        sequence();
    }, [bgControls, outlineLogoControls, solidLogoControls]);

    return (
        <>
            <motion.div className="logo-container" initial={{ opacity: 0 }} animate={bgControls}>
                <motion.img
                    initial={{ opacity: 0 }}
                    animate={solidLogoControls}
